        ...
        <div class="main p-30">
                ...
                <div class="column-wrap">
                    <van-row class="columns">
                        <van-col span="8" v-for="item in columns" :key="item.text" @click="jumpTo(item)">
                            ...
                            <p class="text">{{$t(item.lang)}}</p>
                        </van-col>
                    </van-row>
                </div>
                <div class="adv-section">
                    <span class="adv-tip">{{$t('home.notice')}}</span>
            ...
            <div class="section-wrap">
                <section class="project-list">
                    <c-common-title :title="$t('home.goodProject')" type='project' @more='handleProjectMore'></c-common-title>
...
export default {
    ...
    methods: {
        ...
        initPage() {
            ...
            this.lang = localStore.get('LANG') || '中文'
            this.$forceUpdate()
        },
        // 获取公告列表
        getnoticelist() {
